...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json){
    return Data(
      data: json["data"] == null ? [] : List<TrendingDatum>.from(json["data"]!.map((x) => TrendingDatum.fromJson(x))),
    );
  }
...
class TrendingDatum {
  ...
  factory TrendingDatum.fromJson(Map<String, dynamic> json){
    return TrendingDatum(
      id: json["_id"],
