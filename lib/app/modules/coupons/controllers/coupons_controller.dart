...
import 'package:yalla_coupon/app/modules/coupons/model/single_store_coupons_model.dart';
...
class CouponsController extends GetxController {
  ...
  var singleStoreCoupons = <SingleStoreCouponsDatum>[].obs;
  ...
  Future<void> fetchCouponsByStoreId(String storeId) async {
    try {
      ...
      final singleStoreCouponsModel = SingleStoreCouponsModel.fromJson(data);
