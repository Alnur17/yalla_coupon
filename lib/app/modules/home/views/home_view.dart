      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Obx(() {
              ...
              if (homeController.banners.isEmpty) {
                return SizedBox(
                  height: 50.h,
                  child: Center(
                      child: Text('no_banners_available'
                          .tr)), // Dynamic translation for "No banners available"
                );
              }
                                ...
                                children: [
                                  ...
                                  CustomButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      // If premium and user not logged in → go to login
                                      if (coupon != null &&
                                          coupon.type?.toLowerCase() ==
                                              'premium' &&
                                          token.isEmpty) {
                                        Get.to(
                                            () => CouponsDetailsFromBannerView(
                                                  bannerId: banner.id ?? '',
                                                ));
                                        print(
                                            'Premium coupon, redirecting to login');
                                        return; // stop here, don't copy
                                      }
            ...
            Container(
              ...
              child: Column(
                children: [
                  CustomRowHeader(
                      title: 'categories'.tr,
                      // Dynamic translation for "Categories"
                      onTap: () {
                        Get.to(() => CategoryView());
                      }),
                  sh12,
                      ...
                      if (categoryController.categoryList.isEmpty) {
                        return Center(
                          child: Text(
                            ...
                            // Dynamic translation for "No category available"
                            style: h5,
                          ),
                        );
                      }
            ...
            CustomRowHeader(
              title:
                  "🔥 ${'top_trending_coupons'.tr}", // Dynamic translation for "Top Trending Coupons"
            ),
            sh16,
            Obx(() {
              ...
              if (couponsController.trendingCoupons.isEmpty) {
                return SizedBox(
                  height: 50.h,
                  child: Center(
                      child: Text('no_trending_coupons'
                          .tr)), // Dynamic translation for "No Trending Coupons available"
                );
              }
            ...
            sh16,
            CustomRowHeader(
              title: 'sales_currently'
                  .tr, // Dynamic translation for "Sales Currently"
            ),
            sh12,
            Obx(() {
              ...
              if (homeController.currentlySalesList.isEmpty) {
                return SizedBox(
                  height: 50.h,
                  child: Center(
                      child: Text('no_sales_available'
                          .tr)), // Dynamic translation for "No Sales available"
                );
              }
            ...
            sh16,
            CustomRowHeader(
              title: 'featured_deals'
                  .tr, // Dynamic translation for "Featured Deals"
              // onTap: () {
              //   Get.to(() => CouponsView());
              // },
            ),
            Obx(() {
              ...
              if (couponsController.featuredCoupons.isEmpty) {
                return SizedBox(
                  height: 50.h,
                  child: Center(
                      child: Text('no_featured_coupons'
                          .tr)), // Dynamic translation for "No Featured Coupons available"
                );
              }
            ...
            CustomRowHeader(title: 'your_activity'.tr),
            // Dynamic translation for "Your Activity"
            Obx(() {
              ...
              if (activityLogController.activityList.isEmpty) {
                return Padding(
                  ...
                  child: Center(
                      child: Text("no_activity_yet"
                          .tr)), // Dynamic translation for "No activity yet"
                );
              }
